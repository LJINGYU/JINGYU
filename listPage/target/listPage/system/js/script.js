...
var getScore = function (obj) {
	if(parseInt(obj) == 5){
		var div = "<div title=\"poor\">" +
				"<img src=\"system/js/jquery-raty/img/star-on.png\" alt=\"1\" title=\"poor\">&nbsp;" +
				"<img src=\"system/js/jquery-raty/img/star-on.png\" alt=\"1\" title=\"poor\">&nbsp;" +
				"<img src=\"system/js/jquery-raty/img/star-on.png\" alt=\"1\" title=\"poor\">&nbsp;" +
				"<img src=\"system/js/jquery-raty/img/star-on.png\" alt=\"1\" title=\"poor\">&nbsp;" +
				"<img src=\"system/js/jquery-raty/img/star-on.png\" alt=\"1\" title=\"poor\"></div>";
		return div;
	}
	if(parseInt(obj) == 4){
		var div = "<div title=\"poor\">" +
			...
			"<img src=\"system/js/jquery-raty/img/star-on.png\" alt=\"1\" title=\"poor\">&nbsp;" +
			"<img src=\"system/js/jquery-raty/img/star-on.png\" alt=\"1\" title=\"poor\">&nbsp;" +
			"<img src=\"system/js/jquery-raty/img/star-off.png\" alt=\"1\" title=\"poor\"></div>";
		return div;
	}
	if(parseInt(obj) == 3){
		var div = "<div title=\"poor\">" +
			...
			"<img src=\"system/js/jquery-raty/img/star-on.png\" alt=\"1\" title=\"poor\">&nbsp;" +
			"<img src=\"system/js/jquery-raty/img/star-on.png\" alt=\"1\" title=\"poor\">&nbsp;" +
			"<img src=\"system/js/jquery-raty/img/star-off.png\" alt=\"1\" title=\"poor\">&nbsp;" +
			"<img src=\"system/js/jquery-raty/img/star-off.png\" alt=\"1\" title=\"poor\"></div>";
		return div;
	}
	if(parseInt(obj) == 2){
