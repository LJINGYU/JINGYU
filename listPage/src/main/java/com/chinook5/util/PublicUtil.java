...
public class PublicUtil {
    ...
    public static final String SERVER_GATEWAY_URL = "http://m.5jifeng.cn";

    public static final String CONTEXT_PATH = "/m";

    public static int enCodeCustomerID(int customerID) {
        return customerID * 1234 + 58;
    }

    public static int deCodeCustomerID(int customerID) {
        return (customerID - 58) / 1234;
    }
