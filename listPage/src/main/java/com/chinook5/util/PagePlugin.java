...
/**
 * Created by Spring on 2017/2/22.
 * qq：457540867
 * 对应Mybatis3.4.0之后的版本(包括3.4.0)
 * 3.4.0之前的版本修改intercepts为@Intercepts({@Signature(type = StatementHandler.class, method = "prepare", args = {Connection.class})})
 */
