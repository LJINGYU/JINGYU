                            ...
                            <div class="box border primary">
                                ...
                                <div class="row">
                                    <form id="countryForm"  class="form-horizontal"  style="padding: 10px;">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label  class="col-sm-4 control-label">货币</label>
                                                <div class="col-sm-6">
                                                    <select id="currencyID"  class="col-md-12"></select>
                                                </div>
                                            </div>
                                            <div class="form-group">
...
<script type="text/javascript">
    ...
    $(function () {
        var currency_id = "${country.currency_id}";
        getCurrencyListForSpinner("currencyID",currency_id,false);
    });
